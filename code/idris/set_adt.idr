...
--set_cardinality (mkSet nil) {a=bool}
...
set_witness p (mkSet nil) = none
set_witness p (mkSet (h::t)) = ite (p h)
                               (some h)
                               (set_witness p (mkSet t))
...
--pair elt takes and elt h and a list b and returns list of all pairs,
...
--given a list of a and a list of b rturn a list of all a-b pairs
